...
Once an element has @!important@ styles associated with it, you will find that you cannot simply change the @element.style@ object to affect its styling. Instead, you will need to add a CSS rule to the @element.style.cssText@ property, or to the element's @style@ attribute.

If you are using jQuery, the "Important" plugin can be used to make this process much more easy: "github.com/premasagar/important":http://github.com/premasagar/important
